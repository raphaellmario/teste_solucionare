...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    /*echo "<h3>getPublicacoes('$strUsuario', '$strSenha', $intCodGrupo, $dataInicio, $dataFim, $jornal, $intExportada)</h3>";*/
	try {
		$res = $soap->getPublicacoes($strUsuario, $strSenha, $intCodGrupo, $dataInicio, $dataFim, $jornal, $intExportada);
	}
	catch  (Exception $e)
	{
